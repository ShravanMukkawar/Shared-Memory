...
int main(int argc, char *argv[]){
  ...
  1f:	e8 2c 02 00 00       	call   250 <atoi>
  ...
  27:	6a 05                	push   $0x5
  29:	50                   	push   %eax
  2a:	68 61 79 fe ff       	push   $0xfffe7961
  2f:	e8 2f 03 00 00       	call   363 <shmget>

	if(shmid < 0){
  34:	83 c4 10             	add    $0x10,%esp
  37:	85 c0                	test   %eax,%eax
  39:	78 13                	js     4e <main+0x4e>
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb ba 07 00 00       	mov    $0x7ba,%ebx
 ...
 5d1:	a1 b8 0a 00 00       	mov    0xab8,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 b8 0a 00 00       	mov    %eax,0xab8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6ab:	3b 05 b8 0a 00 00    	cmp    0xab8,%eax
 ...
 6ce:	e8 fd fe ff ff       	call   5d0 <free>
  return freep;
 6d3:	8b 15 b8 0a 00 00    	mov    0xab8,%edx
 ...
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 bc 0a 00 00       	mov    $0xabc,%eax
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 bc 0a 00 00 bc 	movl   $0xabc,0xabc
 726:	0a 00 00 
    base.s.size = 0;
 729:	c7 05 c0 0a 00 00 00 	movl   $0x0,0xac0
 730:	00 00 00 
    if(p->s.size >= nunits){
