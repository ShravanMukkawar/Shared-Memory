...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ad5:	ff 24 85 70 13 00 00 	jmp    *0x1370(,%eax,4)
     ...
     f99:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fb3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  ...
  for(i = 0; fmt[i]; i++){
    ...
    100b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
        putc(fd, c);
      }
      state = 0;
    }
    ...
    1016:	5d                   	pop    %ebp
    1017:	c3                   	ret
    1018:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    101f:	00 
  write(fd, &c, 1);
  ...
  write(fd, &c, 1);
    ...
    1110:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
    1115:	bb 4f 13 00 00       	mov    $0x134f,%ebx
...
malloc(uint nbytes)
{
  ...
  return freep;
    ...
    1288:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
    128f:	00 
        prevp->s.ptr = p->s.ptr;
