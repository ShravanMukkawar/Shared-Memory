...
_shmctl:     file format elf32-i386
...
int main(){
   ...
   f:	8d 75 c0             	lea    -0x40(%ebp),%esi
int main(){
  12:	51                   	push   %ecx
  13:	83 ec 40             	sub    $0x40,%esp
	int id = shmget(1, 12288, IPC_CREAT);
  16:	6a 04                	push   $0x4
  18:	68 00 30 00 00       	push   $0x3000
  1d:	6a 01                	push   $0x1
  1f:	e8 bf 03 00 00       	call   3e3 <shmget>
	printf(1, "created segment with id: %d\n", id);
  ...
  3b:	6a 00                	push   $0x0
  3d:	53                   	push   %ebx
  3e:	e8 a8 03 00 00       	call   3eb <shmat>
	printf(1,"va = %p\n", (int)va);
  ...
  4e:	e8 6d 04 00 00       	call   4c0 <printf>
	shminfo();
  53:	e8 ab 03 00 00       	call   403 <shminfo>
	shmctl(id, IPC_STAT, &buf);
  58:	83 c4 0c             	add    $0xc,%esp
  5b:	56                   	push   %esi
  5c:	6a 01                	push   $0x1
  5e:	53                   	push   %ebx
  5f:	e8 97 03 00 00       	call   3fb <shmctl>
  ...
  67:	ff 75 e4             	push   -0x1c(%ebp)
  6a:	ff 75 dc             	push   -0x24(%ebp)
  6d:	ff 75 d8             	push   -0x28(%ebp)
  70:	ff 75 d4             	push   -0x2c(%ebp)
  73:	ff 75 d0             	push   -0x30(%ebp)
  76:	ff 75 cc             	push   -0x34(%ebp)
  79:	ff 75 c8             	push   -0x38(%ebp)
  7c:	ff 75 c4             	push   -0x3c(%ebp)
  7f:	ff 75 c0             	push   -0x40(%ebp)
  82:	68 f8 07 00 00       	push   $0x7f8
  87:	6a 01                	push   $0x1
  89:	e8 32 04 00 00       	call   4c0 <printf>
    shmctl(id, SHM_INFO, &buf);
  8e:	83 c4 2c             	add    $0x2c,%esp
  91:	56                   	push   %esi
  92:	6a 05                	push   $0x5
  94:	53                   	push   %ebx
  95:	e8 61 03 00 00       	call   3fb <shmctl>
    shmctl(id, IPC_RMID, &buf);
  9a:	83 c4 0c             	add    $0xc,%esp
  9d:	56                   	push   %esi
  9e:	6a 03                	push   $0x3
  a0:	53                   	push   %ebx
  a1:	e8 55 03 00 00       	call   3fb <shmctl>
    shminfo();
  a6:	e8 58 03 00 00       	call   403 <shminfo>
    shmctl(id, IPC_STAT, &buf);
  ab:	83 c4 0c             	add    $0xc,%esp
  ae:	56                   	push   %esi
  af:	6a 01                	push   $0x1
  b1:	53                   	push   %ebx
  b2:	e8 44 03 00 00       	call   3fb <shmctl>
    shmctl(id, IPC_INFO, &buf);
  b7:	83 c4 0c             	add    $0xc,%esp
  ba:	56                   	push   %esi
  bb:	6a 04                	push   $0x4
  bd:	53                   	push   %ebx
  be:	e8 38 03 00 00       	call   3fb <shmctl>
    printf(1, "shmid_ds\n key: %d\n mode: %d\n size: %d\n atime: %d\n dtime: %d\n ctime: %d\n cpid: %d\n lpid: %d\n pa: %p\n", buf.shm_perm.__key, buf.shm_perm.mode, buf.shm_segsz, buf.shm_atime, buf.shm_dtime, buf.shm_ctime, buf.shm_cpid, buf.shm_lpid, buf.pa);
  c3:	83 c4 0c             	add    $0xc,%esp
  c6:	ff 75 e4             	push   -0x1c(%ebp)
  c9:	ff 75 dc             	push   -0x24(%ebp)
  cc:	ff 75 d8             	push   -0x28(%ebp)
  cf:	ff 75 d4             	push   -0x2c(%ebp)
  d2:	ff 75 d0             	push   -0x30(%ebp)
  d5:	ff 75 cc             	push   -0x34(%ebp)
  d8:	ff 75 c8             	push   -0x38(%ebp)
  db:	ff 75 c4             	push   -0x3c(%ebp)
  de:	ff 75 c0             	push   -0x40(%ebp)
  e1:	68 f8 07 00 00       	push   $0x7f8
  e6:	6a 01                	push   $0x1
  e8:	e8 d3 03 00 00       	call   4c0 <printf>

    exit();
  ed:	83 c4 30             	add    $0x30,%esp
  f0:	e8 4e 02 00 00       	call   343 <exit>
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
  f9:	66 90                	xchg   %ax,%ax
  fb:	66 90                	xchg   %ax,%ax
 ...
 428:	89 d1                	mov    %edx,%ecx
{
 ...
 45b:	0f b6 92 b4 08 00 00 	movzbl 0x8b4(%edx),%edx
 ...
 4c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 534:	ff 24 85 5c 08 00 00 	jmp    *0x85c(,%eax,4)
 ...
 640:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 645:	bb ee 07 00 00       	mov    $0x7ee,%ebx
...
free(void *ap)
{
 ...
 651:	a1 58 0b 00 00       	mov    0xb58,%eax
{
 ...
 68f:	5b                   	pop    %ebx
  freep = p;
 690:	a3 58 0b 00 00       	mov    %eax,0xb58
}
 695:	5e                   	pop    %esi
 696:	5f                   	pop    %edi
 697:	5d                   	pop    %ebp
 ...
 6a6:	72 ce                	jb     676 <free+0x26>
{
 ...
 6c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6ca:	a3 58 0b 00 00       	mov    %eax,0xb58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 58 0b 00 00    	mov    0xb58,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 72b:	3b 05 58 0b 00 00    	cmp    0xb58,%eax
 ...
 74e:	e8 fd fe ff ff       	call   650 <free>
  return freep;
 753:	8b 15 58 0b 00 00    	mov    0xb58,%edx
 ...
 797:	0b 00 00 
    base.s.size = 0;
 79a:	b8 5c 0b 00 00       	mov    $0xb5c,%eax
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 5c 0b 00 00 5c 	movl   $0xb5c,0xb5c
 7a6:	0b 00 00 
    base.s.size = 0;
 7a9:	c7 05 60 0b 00 00 00 	movl   $0x0,0xb60
 7b0:	00 00 00 
    if(p->s.size >= nunits){
