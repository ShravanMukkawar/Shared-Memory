...
int main(int argc, char *argv[]){
  ...
  46:	53                   	push   %ebx
  47:	50                   	push   %eax
  48:	e8 3e 03 00 00       	call   38b <removeshm>

	if(r == -1){
  4d:	83 c4 10             	add    $0x10,%esp
  50:	83 c0 01             	add    $0x1,%eax
  53:	74 16                	je     6b <main+0x6b>
  ...
  63:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  66:	e8 58 02 00 00       	call   2c3 <exit>
		printf(1, "Failed to remove the shm segment\n");
  6b:	52                   	push   %edx
  6c:	52                   	push   %edx
  6d:	68 b4 07 00 00       	push   $0x7b4
  72:	6a 01                	push   $0x1
  74:	e8 c7 03 00 00       	call   440 <printf>
  79:	83 c4 10             	add    $0x10,%esp
  7c:	eb e8                	jmp    66 <main+0x66>
  7e:	66 90                	xchg   %ax,%ax
 ...
 3a8:	89 d1                	mov    %edx,%ecx
{
 ...
 3db:	0f b6 92 50 08 00 00 	movzbl 0x850(%edx),%edx
 ...
 449:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4b4:	ff 24 85 f8 07 00 00 	jmp    *0x7f8(,%eax,4)
 ...
 5c0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5c5:	bb ef 07 00 00       	mov    $0x7ef,%ebx
...
free(void *ap)
{
 ...
 5d1:	a1 f4 0a 00 00       	mov    0xaf4,%eax
{
 ...
 60f:	5b                   	pop    %ebx
  freep = p;
 610:	a3 f4 0a 00 00       	mov    %eax,0xaf4
}
 615:	5e                   	pop    %esi
 616:	5f                   	pop    %edi
 617:	5d                   	pop    %ebp
 ...
 626:	72 ce                	jb     5f6 <free+0x26>
{
 ...
 647:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 64a:	a3 f4 0a 00 00       	mov    %eax,0xaf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ab:	3b 05 f4 0a 00 00    	cmp    0xaf4,%eax
 ...
 6ce:	e8 fd fe ff ff       	call   5d0 <free>
  return freep;
 6d3:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6ff:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
}
 ...
 70f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 710:	c7 05 f4 0a 00 00 f8 	movl   $0xaf8,0xaf4
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 f8 0a 00 00       	mov    $0xaf8,%eax
    base.s.ptr = freep = prevp = &base;
 71f:	c7 05 f8 0a 00 00 f8 	movl   $0xaf8,0xaf8
 726:	0a 00 00 
    base.s.size = 0;
 729:	c7 05 fc 0a 00 00 00 	movl   $0x0,0xafc
 730:	00 00 00 
    if(p->s.size >= nunits){
